...
const DataGapDetection = () => {
  const [searchTerm, setSearchTerm] = useState('');
  const mockData = Array(5).fill(0).map((_,i) => ({id: 'Sample ' + i, zone: 'Sample ' + i, sensor: 'Sample ' + i, duration: 'Sample ' + i, severity: 'Sample ' + i, cause: 'Sample ' + i}));
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Data Gap Detection</h2>
...
export default DataGapDetection;
