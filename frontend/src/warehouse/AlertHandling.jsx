...
const AlertHandling = () => {
  ...
  const mockData = Array(5).fill(0).map((_,i) => ({id: 'Sample ' + i, severity: 'Sample ' + i, message: 'Sample ' + i, zone: 'Sample ' + i, status: 'Sample ' + i}));
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Alert Handling</h2>
