  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Document Validation</h2>
   ...
   <p className="mb-4">This section displays Document Validation data securely retrieved from the blockchain.</p>
