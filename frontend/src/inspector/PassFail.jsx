...
const PassFail = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Inspection Verdict</h2>
  ...
  <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Inspection ID</label>
  <input type="text" name="inspection_id" placeholder="Enter Inspection ID" required className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-red-500 focus:outline-none" />
</div>
<div className="space-y-2">
  <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Decision</label>
  <input type="text" name="decision" placeholder="Enter Decision" required className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-red-500 focus:outline-none" />
</div>
